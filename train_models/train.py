...
def train(net_factory, prefix, end_epoch, base_dir,
    ...
    #class,regression
    cls_loss_op,bbox_loss_op,landmark_loss_op,L2_loss_op,accuracy_op, plandmark = net_factory(input_image, label, bbox_target,landmark_target,training=True)
    ...
    try:
        for step in range(MAX_STEP):
            ...
            _,_,summary, pland = sess.run([train_op, lr_op, summary_op, plandmark], feed_dict={input_image: image_batch_array, label: label_batch_array, bbox_target: bbox_batch_array,landmark_target:landmark_batch_array})
